...
public class ThreePlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thpPlayer1Btn.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        thpPlayer2Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                thp_p2_score++;
        ...
        thpPlayer3Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                thp_p3_score++;
        ...
        thpPlayer1Btn.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
        ...
        thpPlayer2Btn.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                if (thp_p2_score > 0) {
                    thp_p2_score--;
        ...
        thpPlayer3Btn.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                if (thp_p3_score > 0) {
                    thp_p3_score--;
        ...
        thpResetBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                thp_p1_score = 0;
                thp_p2_score = 0;
        ...
        thpChangeNameBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showAlertDialog();
            }
